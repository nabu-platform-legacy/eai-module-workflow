...
public interface WorkflowManager {
	...
	public List<WorkflowInstance> getWorkflows(@WebParam(name = "connectionId") String connectionId, @WebParam(name = "systemId") @NotNull String systemId, @WebParam(name = "definitionId") String definitionId, Level state);
